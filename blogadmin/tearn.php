...
<div class="clearfix"></div>
 ...
 <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Post Data Table</div>
            <div class="card-body">
...
$lqs="SELECT * FROM post_table WHERE DELE=0 ORDER BY DATE_TIME DESC ";
                            ...
                            if($query_runv=mysqli_query($con,$lqs))
                            {
                                    ...
                                    if($countq>0)
                                    {
                                            ...
                                            {
                                              $roww['TITLE']=base64_decode($roww['TITLE']);

                    echo ('<tr>
                        <td>'.$roww["AUTHOR"].'</td>
                        <td>'.$roww["AUTHOR_ID"].'</td>
                        <td>'.$roww["TITLE"].'</td>
                        <td>'.$roww["DATE_TIME"].'</td>
                        <td>
                         <button type="button" class="btn btn-white btn-sm btn-round waves-effect waves-light m-1" data-toggle="modal" data-target="#largesizemodal'.$roww["ID"].'">Comments</button>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Student data</div>
            <div class="card-body">
              <div class="table-responsive">
              <table id="example" class="table table-bordered">
                <thead>

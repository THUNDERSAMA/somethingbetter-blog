...
<?php 
					...
					<div class="col-md-2">
						<a href="author.html"><img class="author-thumb" src="'.$row['AUTHOR_IMG'].'" alt="Sal"></a>
					</div>
					<div class="col-md-10">
						<a class="link-dark" href="author.html">'.$row['AUTHOR'].'</a><a href="#" class="btn follow">Follow</a>
...
<script src="asset/js/mediumish.js"></script>
</body>
</html>

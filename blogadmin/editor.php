    ...
    <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
               <input type="text" class="form-control form-control-rounded" id="heads">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <div class="col-lg-6">
               <button type="button" class="btn btn-primary btn-lg btn-round btn-block waves-effect waves-light m-11" onclick="myFunction()">PUBLISH</button>
             </div>
          </div>
<!--start overlay-->
    ...
    var data = {
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                    ...
                                    if(result == 'OK' )
                                    {
                                      swal("HURRAY!", " Blog posted", "success");

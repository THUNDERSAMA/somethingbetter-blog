  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
       <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Add Topics</div>
            <div class="card-body">
              <form>
                  

                    <input type="text" class="form-control form-control-rounded" id="topic">
                    <button type="button" class="btn btn-primary btn-round waves-effect waves-light m-1" onclick="addt()">Add</button>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Topics available</div>
            <div class="card-body">
              <form>
                            ...
                            if($query_run=mysqli_query($con,$qlz))
                            {
                                    ...
                                    if($counts>0)
                                    {
                                            while($row= mysqli_fetch_assoc($query_run))
                                            {
                                               ...
                                               echo ' <input type="text" class="form-control" id="tsp" data-role="tagsinput" value="'.$ads.'"/>';
...
<!--start overlay-->
  ...
  <script type="text/javascript">
    ...
    {
      //alert("hi");
      var idp=document.getElementById('topic').value;
         var data = {
                            cmd: 'register',
                            emk:idp,
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                  ...
                                  {
                                  // swal('VERIFIED','student', "success");  
                               var dfs=document.getElementById('tsp').value;
                               $('#tsp').tagsinput('add', idp);

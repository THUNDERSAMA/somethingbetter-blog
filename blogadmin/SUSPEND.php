  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu">
    ...
    <ul class="sidebar-submenu">
      <li><a href="authentication-signup2_1T.php"><i class="zmdi zmdi-dot-circle-alt"></i>Student</a></li>
      ...
      <li>
        ...
        <li><a href="SPAY.php"><i class="fa fa-inr"></i>Student Payments</a></li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
          ...
          <li><a href="SUSPEND.php"><i class="zmdi zmdi-dot-circle-alt"></i>Student</a></li>
      ...
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" data-toggle="dropdown" href="javascript:void();">
         <?php 
                     include 'db.php';
                            ...
                            $ql="SELECT * FROM 2021f WHERE (VERIFY=0) AND (R_ID=$ds) AND (JAN=1 OR FEB=1 OR MAR=1 OR APR=1 OR MAY=1 OR JUN=1 OR JUL=1 OR AUG=1 OR SEPT=1 OR OCT=1 OR NOV=1 OR DECE=1) ORDER BY DATE_TIME DESC";
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
   ...
   <div class="col-12 col-lg-12">
     <div class="card">
       <div class="card-header">Suspend Table
      <div class="card-action">
         ...
         <div class="table-responsive">
           ...
           $IPDS= $_SESSION['ID'];
                            ...
                            $ql="SELECT * FROM users WHERE LEVEL!=2 AND DELETED=0 AND LEVEL!=1 AND REG_BY=$IPDS";
